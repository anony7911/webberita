                ...
                <div class="bg-gradient-warning shadow-primary border-radius-lg pt-4 pb-3 pl-3">
                    <div class="row">
                        <div class="col-6 d-flex align-items-left">
                            <h4 class="text-white text-capitalize ps-3">KATEGORI ARTIKEL</h4>
                        </div>
                        <div class="col-6 text-end" style="padding-right: 2rem">
                            ...
                            <button class="btn bg-gradient-dark mb-0" wire:click='klikTambah()'><i
                                    class="material-icons text-sm">add</i>&nbsp;&nbsp;Tambah Kategori</button>
                            @elseif($isTambah == false && $isEdit == true )
                            <button type="button" class="btn bg-gradient-dark mb-0" wire:click='klikTambah()'
                                disabled><i class="material-icons text-sm">add</i>&nbsp;&nbsp;Tambah Kategori</button>
                            @else
            ...
            <div class="card-body px-0 pb-2">
                ...
                <form id="isTambah" class="py-4 px-4 pt-0">
                    ...
                    <div class="input-group input-group-dynamic mb-1">
                        <input wire:model="nama_kategori" type="text" class="form-control" id="basic-url"
                            aria-describedby="basic-addon3" placeholder="nama kategori">
                        @error('nama_kategori') <span class="text-danger">{{ $message }}</span>@enderror
                    </div>
                    <div class="input-group input-group-dynamic mb-1">
                        <input wire:model="slug_kategori" type="text" class="form-control" id="basic-url"
                            aria-describedby="basic-addon3" placeholder="nama-kategori">
                        @error('slug_kategori') <span class="text-danger">{{ $message }}</span>@enderror
                    </div>
                    <div class="mb-1">
                    ...
                    <div class="col-md-3 d-flex align-items-center mb-2 " style="margin-left: 25px;margin-right: 4rem">
                        <div class="input-group input-group-outline">
                            ...
                            <input wire:model.debounce.500ms="search" id="cari" type="text" class="form-control"
                                onfocus="focused(this)" onfocusout="defocused(this)" placeholder="Ketik nama kategori...">
                        </div>
                    </div>
                </div>
                <div class="table-responsive p-0">
                    <table class="table align-items-center mb-2">
                        <thead>
                            <tr>
                                <th class="text-left text-uppercase text-secondary text-xs font-weight-bolder opacity-7">Nama kategoris
                                </th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p class="text-xs font-weight-bold mb-0">{{ $kategori->slug_kategori }}</p>
                                </td>
                                <td class="align-middle text-left">
                                    <span
                                        class="text-secondary text-xs font-weight-bold">{{ $kategori->created_at }}</span>
                                </td>
