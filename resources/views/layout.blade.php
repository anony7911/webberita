                ...
                <div class="col-lg-5 col-sm-12  order-first order-sm-0">
                    ...
                    <div>
                        <div class="position-relative overflow-hidden mb-3" style="height: 300px;">
                            ...
                            <div class="overlay">
                                <div class="" style="font-size: 13px; margin-bottom: 3.8rem !important">
                                    <button class="btn btn-sm btn-primary text-white font-weight-bold mb-5"
                                        style="margin-left:  -0.9rem !important; margin-bottom: 3.3rem !important">HEADLINE</button>
                                </div>
                                <div class="mt-4">
                                    @foreach ($headlines->kategoris as $kategori)
                                    <a class="text-white" href="{{ url('/'.$kategori->nama_kategori) }}">
                                        {{ ucfirst($kategori->nama_kategori) }}
                                        <span class="px-2 text-white">/</span>
                                        <a class="text-white" href="">{{ $headlines->created_at->isoFormat('D MMMM Y'); }}</a>
                                        @endforeach </a>
                                </div>
                                <a class="h4 m-0 font-weight-bold text-white text-capitalize" href="">{{ Str::words($headlines->judul, 11) }}</a>
                            </div>
                        </div>
                    </div>
                    <div>
