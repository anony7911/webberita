...
<head>
    <meta charset="utf-8">
    <title>Kode Etik Internal | Kolaka Update</title>
                ...
                <div class="col-lg-9 col-sm-12  order-first order-sm-0">
                    <div>
                        <div class="d-flex align-items-center justify-content-between bg-primary py-2 px-4 mb-3">
                            <h3 class="m-0 text-light">Kode Etik internal</h3>
                        </div>
                        <div class="text-justify align-items-start justify-content-between bg-light py-2 px-4 mb-3">
                            <p class="mt-2">
                                1. Saat menjalankan tugas, Wartawan dan Staf Perusahaan Media Online kolakaupdate.com
                                dilengkapi dengan identitas (Kartu Pers) dan Id Card Perusahaan dan tercantum dalam Box
                                Redaksi.
                            </p>
                            <p>2. Narasumber bila merasa ada kejanggalan dari identitas Wartawan kolakaupdate.com atau
                                mendapatkan perilaku tidak wajar dari wartawan, dapat menghubungi tim redaksi dari
                                kolakaupdate.com melalui surat elektronik ke: kolakaupdate@gmail.com.</p>
                            <p>3. Wartawan kolakaupdate.com dilarang meminta dan menerima uang maupun barang apapun
                                dari narasumber.</p>

                            <p>4. Setiap berita yang terpublikasi adalah kewenangan tim redaksi dari kolakaupdate.com.
                            </p>
                            <p>5. Permintaan untuk ralat, koreksi, revisi atau hak jawab terkait artikel yang telah
                                diterbitkan berdasarkan Kode Etik Jurnalistik (KEJ) dan Undang
                                Undang Pokok Pers.</p>
                            <p>6. Ralat bisa melalui pengiriman surat elektronik (surel)/email ke:
                                kolakaupdate@gmail.com dengan menggunakan subjek: HAK JAWAB. Dalam surat
                                elektronik tersebut, disebutkan bagian yang dianggap tidak tepat berikut tautan dari
                                artikel, serta pemohon wajib menyebutkan identitas dengan jelas.</p>
                        </div>
                    </div>
                </div>
                {{-- end-content --}}
